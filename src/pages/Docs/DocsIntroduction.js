...
const DocsIntroduction = () => {
  const installationCode = `npm install @CaoSon/ui

// or

yarn add @CaoSon/ui`;

  const importCode = `import { Typography, Card, Button, Stack, Grid, AppBar } from '@CaoSon/ui';`;

  const basicExampleCode = `import React from 'react';
import { Typography, Card, Button } from '@CaoSon/ui';
...
export default App;`;
  ...
  const cardExampleCode = `import { Card, Typography } from '@CaoSon/ui';
...
<Card variant="standard">
  ...
  const typographyExampleCode = `import { Typography } from '@CaoSon/ui';
...
<Typography variant="button">BUTTON TEXT</Typography>`;
  ...
  const buttonExampleCode = `import { Button } from '@CaoSon/ui';

<Button variant="text">Text</Button>
<Button variant="contained">Contained</Button>
<Button variant="outlined">Outlined</Button>`;

  const stackExampleCode = `import { Stack } from '@CaoSon/ui';
...
<Stack direction="row" spacing={2}>
  ...
  const gridExampleCode = `import { Grid } from '@CaoSon/ui';
    ...
    <div>
      <div className={styles.header}>
        ...
        <p className={styles.description}>
          Welcome to CaoSon Component Library - A modern React component library for building beautiful user interfaces.
        </p>
      </div>
      ...
      <section className={styles.section}>
        ...
        <p className={styles.sectionDescription}>
          CaoSon UI is a collection of reusable React components that follow Material Design principles. 
